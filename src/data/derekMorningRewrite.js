...
const derekCopy = new Map([
  ...
  ["Просто хотелось, чтобы хоть что-то стало понятнее.", "Я думал, хоть так что-то прояснится."]
]);
...
const derekChoiceCopy = {
  ...
  morning_derek_more_photos: [
    ...
    "Посмотрю. Только без ещё одного допроса."
  ],
  morning_derek_photo_set: [
    "Нет. Я её правда не узнаю.",
    "Нет. Но теперь Харпер хотя бы не просто имя.",
    "Нет. И мне уже неловко повторять это в третий раз."
  ],

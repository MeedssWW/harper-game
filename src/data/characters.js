...
export const charactersMap = {
  ...
  derek: {
    ...
    name: "Дерек Миллер",
    avatarColor: "#3b82f6",
    avatarImage: "src/assets/social_profiles/v2/derek/life-1.webp",
    phone: "+1 (406) 555-0198",
    handle: "@derek.m",
    socialPhoto: "src/assets/social_profiles/v2/derek/life-4.webp",
    gallery: ["life-1.webp", "life-2.webp", "life-3.webp", "life-4.webp"].map(file => `src/assets/social_profiles/v2/derek/${file}`),
  ...
  tyler: {
    ...
    name: "Тайлер Росс",
    avatarColor: "#0f766e",
    avatarImage: "src/assets/social_profiles/v2/tyler/life-1.webp",
    phone: "+1 (971) 555-0134",
    handle: "@tyler.ross",
    socialPhoto: "src/assets/social_profiles/v2/tyler/life-4.webp",
    gallery: ["life-1.webp", "life-2.webp", "life-3.webp", "life-4.webp"].map(file => `src/assets/social_profiles/v2/tyler/${file}`),
  ...
  mason: {
    ...
    name: "Мейсон Коул",
    avatarColor: "#ef4444",
    avatarImage: "src/assets/social_profiles/v2/mason/life-1.webp",
    phone: "+1 (503) 555-0172",
    handle: "@mason.c",
    socialPhoto: "src/assets/social_profiles/v2/mason/life-2.webp",
    gallery: ["life-1.webp", "life-2.webp", "life-3.webp", "life-4.webp"].map(file => `src/assets/social_profiles/v2/mason/${file}`),
  ...
  olivia: {
    ...
    name: "Оливия Грант",
    avatarColor: "#a855f7",
    avatarImage: "src/assets/social_profiles/v2/olivia/life-1.webp",
    phone: "+1 (360) 555-0116",
    handle: "@olivia.grant",
    socialPhoto: "src/assets/social_profiles/v2/olivia/life-3.webp",
    gallery: ["life-1.webp", "life-2.webp", "life-3.webp", "life-4.webp"].map(file => `src/assets/social_profiles/v2/olivia/${file}`),
  ...
  mia: {
    ...
    name: "Миа Картер",
    avatarColor: "#22c55e",
    avatarImage: "src/assets/social_profiles/v2/mia/life-1.webp",
    phone: "+1 (541) 555-0183",
    handle: "@mia.carter",
    socialPhoto: "src/assets/social_profiles/v2/mia/life-2.webp",
    gallery: ["life-1.webp", "life-2.webp", "life-3.webp", "life-4.webp"].map(file => `src/assets/social_profiles/v2/mia/${file}`),
  ...
  brooke: {
    ...
    name: "Брук Хейз",
    avatarColor: "#64748b",
    avatarImage: "src/assets/social_profiles/v2/brooke/life-1.webp",
    phone: "+1 (458) 555-0107",
    handle: "@brooke.hayes",
    socialPhoto: "src/assets/social_profiles/v2/brooke/life-3.webp",
    gallery: ["life-1.webp", "life-2.webp", "life-3.webp", "life-4.webp"].map(file => `src/assets/social_profiles/v2/brooke/${file}`),

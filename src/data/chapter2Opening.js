...
export const chapter2OpeningBeats = [
  ...
  {
    id: 'ep2_police_unknown_screens_prompt',
    chat: 'private_detective',
    trigger: 'after:ep2_police_unknown_told',
    messages: [
      { type: 'choice', options: [
  ...
  {
    id: 'ep2_police_log_prompt',
    chat: 'private_detective',
    trigger: 'after:ep2_police_log_told',
    messages: [
      { type: 'choice', options: [
  ...
  },
  {
    ...
    chat: 'private_detective',
    trigger: 'choice:ep2_police_unknown_screens_prompt:0',
    messages: [
  ...
  },
  {
    ...
    chat: 'private_detective',
    trigger: 'choice:ep2_police_log_prompt:1',

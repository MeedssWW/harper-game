...
const BASE_POSTS = [
    ...
    { id: 'larks-board', author: 'Larks', handle: '@larks.rw', avatar: `${A}/page-larks-v2.webp`, image: `${A}/post-larks-coffee.webp`, likes: 72, age: '3 ч', text: 'На доске снова появилось место. Несите объявления, рисунки и пропавшие перчатки. Политику снимем.', comments: [['eli', 'велосипед за окном считается объявлением?'], ['leya', 'если приклеишь его к доске'], ['olivia', 'Пожалуйста, не давайте ему идей.']] },
    { id: 'mia-jacket', author: 'Миа Картер', handle: '@mia.carter', avatar: 'src/assets/social_profiles/v3/mia/life-3.webp', image: 'src/assets/social_profiles/v3/mia/life-4.webp', likes: 108, age: 'вчера', profile: 'mia', text: 'Куртка остаётся. Все жалобы принимаются и игнорируются.', comments: [['harper', 'эта куртка выглядит как дорогой мокрый пакет'], ['mia', 'и всё равно ты постоянно её у меня забираешь'], ['harper', 'не постоянно'], ['olivia', 'У меня есть доказательства. И не одно.']] },
    { id: 'market', author: 'Riverwalk Market', handle: '@riverwalk.market', avatar: `${A}/page-market-v2.webp`, image: `${A}/post-market.webp`, likes: 39, age: 'вчера', text: 'Субботний обмен: книги, пластинки, одежда и вещи, которые жалко выбросить. Столы под навесом.', comments: [['june', 'кто-нибудь заберите у меня лампу'], ['noah', 'ту самую страшную?'], ['june', 'она винтажная'], ['noah', 'она наблюдает за людьми']] },
